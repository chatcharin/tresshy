...
public class FStest1 extends JFrame {
	...
	public static void main(String[] args) throws Exception {
		if (args.length < 1) // by default program will load AnyExample logo
			new FStest1("http://www.anyexample.com/i/logo.gif");
		else
			new FStest1(args[0]); // or first command-line argument
	}

	// Class constructor
	FStest1(String source) throws MalformedURLException {
